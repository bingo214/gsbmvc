<div id="contenu">
    ...
    <?php if(isset($laFiche)){ ?>
        ...
        <p>
            <h3><a target="_blank" href="index.php?uc=suiviPaiement&action=generatePDF&fiche=<?= $_GET['fiche'] ?>" style="line-height:28px; padding-left:10px;"><img src="images/icon_pdf.png" width="28px">Télécharger PDF</a></h3>
